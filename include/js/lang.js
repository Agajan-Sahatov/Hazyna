...
request.open('GET', 'include/json/lang.json');
request.onreadystatechange = function() {
	if ((request.readyState===4) && (request.status===200)) {
		...
		var output = document.getElementById('selected').textContent;
		document.getElementById('pagename').innerHTML = '<img src="include/css/images/little/triangle.jpg" alt="" id="triangle"/>' + output;
	}
}
request.send();